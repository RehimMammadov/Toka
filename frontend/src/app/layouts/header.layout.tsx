...
export default function Header() {
    useAOS();
    return (
        <header className="w-full h-[130vh] bg-[#030811] relative">
            <Navbar />
            <div className="p-[12%] pb-20 flex justify-center gap-28">
                <div data-aos="fade-down">
                    <h1 className="text-7xl text-white font-medium leading-tight ">Make your life<br /> easier with <br /> crypto.</h1>
